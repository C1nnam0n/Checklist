...
//
/*oppsy bedą obiektami dzięki temu wpierdole im name i tatus(czy zajebani)
 * dopierdole jeszcze że wszystko do pliku się zapisuje i będe mógł odczytać z
 * pliku w mainie będzie opcja [0] dodaj bossa, [1] usun bossa(i guess ?) [2]
 * wyświetl całą liste*/
#include <fstream>
#include <iostream>
#include <unistd.h>
...
int main() {
  ...
  case 1: {
    ...
    std::cout << "Enter names of the bosses and state is he dead or alive, "
                 "press 's' and then enter to stop"
              << '\n';
  ...
  default:
    throw std::runtime_error("Cannot do");
  }
  char cwd[1024];
